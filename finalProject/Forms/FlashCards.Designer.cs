namespace finalProject.Forms
{
    partial class FlashCards
    {
        ...
        private void InitializeComponent()
        {
            ...
            //Card.Add(new Card("Front 1", "Back 1", btnCard1));
            //Card.Add(new Card("Front 2", "Back 2", btnCard2));
            //Card.Add(new Card("Front 3", "Back 3", btnCard3));
            //Card.Add(new Card("Front 4", "Back 4", btnCard4));
            //Card.Add(new Card("Front 5", "Back 5", btnCard5));
            //Card.Add(new Card("Front 6", "Back 6", btnCard6));
            //Card.Add(new Card("Front 7", "Back 7", btnCard7));
            //Card.Add(new Card("Front 8", "Back 8", btnCard8));
